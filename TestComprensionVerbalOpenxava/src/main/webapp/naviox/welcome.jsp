...
En TestComprensionVerbalOpenxava-labels_es.properties:
TestComprensionVerbalOpenxava=Tu aplicación
TestComprensionVerbalOpenxava[description]=Tu aplicación hace esto y lo otro

En TestComprensionVerbalOpenxava-messages_en.properties:
