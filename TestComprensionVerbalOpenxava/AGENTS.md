...
- Crea la clase de la acción en el paquete `com.yourcompany.TestComprensionVerbalOpenxava.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.yourcompany.TestComprensionVerbalOpenxava.acciones.MostrarImporte"/>
</controlador>
```

```java
package com.yourcompany.TestComprensionVerbalOpenxava.acciones;
...
- ✅ Coloca las clases de acción en `com.yourcompany.TestComprensionVerbalOpenxava.acciones`
...
```java
package com.yourcompany.TestComprensionVerbalOpenxava.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `com.yourcompany.TestComprensionVerbalOpenxava.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
